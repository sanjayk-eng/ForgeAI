...
const oauthButtonClass =
  "flex h-11 items-center justify-center gap-2 rounded-[10px] border border-white/15 bg-white/[0.02] text-[13px] font-bold text-[#edf2ee] no-underline transition hover:border-forge-accent/45 hover:bg-forge-accent/10";
    ...
    <div className="mx-auto w-full max-w-[420px]">
      <div className="mb-7">
        ...
        <p className="m-0 leading-[1.6] text-forge-soft">
          Sign in to return to your ForgeAI workspace.
        </p>
      </div>
