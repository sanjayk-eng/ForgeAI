...
export function AuthLayout() {
  return (
    <main className="grid min-h-screen bg-forge-bg lg:grid-cols-[minmax(300px,0.92fr)_minmax(460px,1.08fr)]">
      <aside className="relative hidden min-h-screen flex-col justify-between overflow-hidden border-r border-white/15 bg-gradient-to-b from-[#0e1715] to-[#111d1a] p-9 text-[#edf5ef] lg:flex lg:px-12" aria-label="ForgeAI workspace">
        ...
        <div className="relative z-10 max-w-[440px]">
          <p className="m-0 font-mono text-[11px] uppercase tracking-[0.08em] text-forge-accent">Agent workspace</p>
          <h1 className="my-[18px] text-[clamp(42px,4.6vw,64px)] font-extrabold leading-[0.97] tracking-[-0.06em]">Build with focus.</h1>
