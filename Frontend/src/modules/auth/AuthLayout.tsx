...
export function AuthLayout() {
  ...
  return (
    <main className="grid min-h-screen bg-forge-bg lg:h-screen lg:min-h-0 lg:overflow-hidden lg:grid-cols-[minmax(300px,0.92fr)_minmax(460px,1.08fr)]">
      <aside className="relative hidden min-h-screen flex-col justify-between overflow-hidden border-r border-[var(--border)] bg-forge-panel p-9 text-forge-text lg:flex lg:px-12" aria-label="ForgeAI workspace">
        <AuthSolarSystem />
